...
public class HttpsRequestsToMatrix {
	...
	public static void sendInvitationToUser(String accessToken, String roomId, String invitedUserAdress) throws IOException{
		...
		StringBuilder url=new StringBuilder(Constant.DEFAULT_MATRIX_SERVER).append("/_matrix/client/r0/rooms/").append(roomId).append("/invite").append("?access_token=").append(accessToken);
	...
	public static void joinRoom(String accessToken, String roomId) throws IOException{
		StringBuilder url=new StringBuilder(Constant.DEFAULT_MATRIX_SERVER).append("/_matrix/client/r0/join/").append(roomId).append("?access_token=").append(accessToken);
